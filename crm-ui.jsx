  ...
  return (
    <aside style={{ width: 220, background: NAVY, display: 'flex', flexDirection: 'column', flexShrink: 0, height: '100vh', position: 'sticky', top: 0 }}>
      <div style={{ padding: '20px 16px 14px', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
        <img src="uploads/Logo.jpg" alt="MemphisClean" style={{ width: '100%', maxWidth: 160, filter: 'brightness(0) invert(1)', opacity: 0.95 }} />
        <div style={{ marginTop: 8, fontSize: 10, color: 'rgba(255,255,255,0.5)', letterSpacing: '0.12em', textTransform: 'uppercase', fontWeight: 600 }}>CRM — Sales Desk</div>
      </div>
...
const ROLE_PERMISSIONS = {
  admin: {
    nav: ['dashboard','queue','pipeline','contacts','calendar','import','manager'],
    label: 'Administrator',
  },
  rep: {
